...
const CTASection = () => {
  return (
    <section id="cta" className="py-16 md:py-24 bg-co-purple-dark text-co-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl sm:text-4xl font-bold mb-6">Pronto para Transformar suas Compras?</h2>
        <p className="text-lg text-co-gray-light/80 max-w-xl mx-auto mb-10">
          Entre em contato conosco e descubra como o Comunica Obra pode otimizar seu tempo e seus custos.
        </p>
        <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
          <Button 
            size="lg"
            className="bg-co-white text-co-purple-primary hover:bg-co-gray-light/90 group w-full sm:w-auto"
        ...
        <p className="mt-8 text-co-gray-light/70 text-sm">
